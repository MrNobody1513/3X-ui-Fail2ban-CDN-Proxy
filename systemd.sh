...
LOG_FILE_PATH="/var/log/userlimit-v3.log" # A variable for the log file path
...
ExecStart=$PYTHON_PATH -u $PYTHON_SCRIPT_PATH
Restart=always
RestartSec=5
